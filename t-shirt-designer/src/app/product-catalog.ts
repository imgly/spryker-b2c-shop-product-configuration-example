...
export interface ProductConfig {
  ...
  sizes?: ProductSize[];
  /** Brand name shown above the product title (e.g. "alpinestars"). */
  brand?: string;
  /** Secondary product line shown under the title (e.g. "MX Jersey"). */
  subtitle?: string;
  /** Catalogue article number. */
  artNo?: string;
  /** Manufacturer's recommended retail price (UVP), struck through. */
  listPrice?: number;
}
