...
use Pyz\Zed\Oms\Communication\Plugin\Oms\Command\SendDesignToFulfillmentCommandPlugin;
...
class OmsDependencyProvider extends SprykerOmsDependencyProvider
{
    ...
    protected function extendCommandPlugins(Container $container): Container
    {
        $container->extend(self::COMMAND_PLUGINS, function (CommandCollectionInterface $commandCollection) {
            ...
            // Designer integration: forward configured order item's print assets to fulfillment.
            $commandCollection->add(new SendDesignToFulfillmentCommandPlugin(), 'TshirtDesigner/SendToFulfillment');
    ...
    protected function extendConditionPlugins(Container $container): Container
    {
        $container->extend(self::CONDITION_PLUGINS, function (ConditionCollectionInterface $conditionCollection) {
            ...
            $conditionCollection->add(new IsOrderAmendmentDraftSuccessfullyAppliedConditionPlugin(), 'DummyOrderAmendmentAsync/IsSuccessfullyApplied');
